...
export default class MovieDB {
  ...
  async createGuestSession() {
    let res = await fetch(
      'https://api.themoviedb.org/3/authentication/guest_session/new?api_key=cebc84ab1d17ead9d5402d3d6b93ddc1'
    );
  ...
  async getRatedMovies(guest_session_id) {
    let res = await fetch(
      `https://api.themoviedb.org/3/guest_session/${guest_session_id}/rated/movies?api_key=cebc84ab1d17ead9d5402d3d6b93ddc1&sort_by=created_at.asc`
    );
